...
function showSection(sectionId) {
    ...
    if (activeButton) {
        ...
        activeButton.style.backgroundColor = "#F5EEFF"; // Change background color to active color
        activeButton.style.color = "#943FFF";
    }
    ...
    if (sectionId === 'all') {
        ...
        if (allButton) {
            ...
            allButton.style.backgroundColor = "#F5EEFF"; // Set background color to default
            allButton.style.color = "#943FFF";
        }
    }
}
